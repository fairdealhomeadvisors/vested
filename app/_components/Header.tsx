  ...
  return (
    <div className="p-5 flex items-start justify-between">
      ...
      <div className="flex items-center gap-5">
        <Link href={props.emailLink} className="cursor-pointer">
          <EnvelopeIcon className="w-6 h-6 text-white" />
        </Link>

        <Link href={props.whatsappLink} className="cursor-pointer">
        ...
        <span className="text-2xl hidden md:block text-white">
          {props.phoneNumber}
        </span>
      </div>
